...
defaultcfg = {
	...
	34: [64, 64, 64, 64, 64, 'M', 128, 128, 128, 128, 128, 'M', 256, 256, 256, 256, 256, 256, 256, 'M',
	     512, 512, 512, 512, 512, 512, 512, 'M', 512, 512, 512, 512, 512, 512, 512],
	49: [64, 64, 64, 64, 64, 'M', 64, 64, 64, 'M', 128, 128, 128, 128, 128, 'M', 128, 128, 128, 'M',
	     256, 256, 256, 256, 256, 256, 256, 'M', 256, 256, 256, 'M',
	     512, 512, 512, 512, 512, 512, 512, 'M', 512, 512, 512, 'M', 512, 512, 512, 512, 512, 512, 512, 'M', 512, 512,
	     512],
}
...
class VGG(nn.Module):
	def __init__(self, dataset='cifar10', depth=19, init_weights=True, cfg=None, affine=True, batchnorm=True, act='relu'):
	...
	def make_layers(self, cfg, batch_norm=False):
		...
		for v in cfg:
			if v == 'M':
				...
				if batch_norm:
					layers += [padding_cir(), conv2d, nn.BatchNorm2d(v, affine=self._AFFINE), self.activation]
				else:
